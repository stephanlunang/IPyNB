...
#define  pANALYSIS                       1       /* callback function: analysis_panel */
#define  pANALYSIS_CALCULATE             2       /* callback function: fit_control */
#define  pANALYSIS_BACK_SHIRLEY          3       /* callback function: fit_control */
#define  pANALYSIS_FIT_APPLY             4       /* callback function: fit_control */
...
#define  pVIEWER_DECORATION_2            10
#define  pVIEWER_CURVE_BOX_MSG           11
#define  pVIEWER_DECORATION              12
#define  pVIEWER_INSTRUMENT              13
#define  pVIEWER_REGION_SCAN_MODE_MSG    14
#define  pVIEWER_REGION_SCANS            15
#define  pVIEWER_REGION_DWELL            16
#define  pVIEWER_DECORATION_3            17
#define  pVIEWER_E_DESCRIPTION           18
#define  pVIEWER_R_DESCRIPTION           19
#define  pVIEWER_DECORATION_4            20
#define  pVIEWER_LAYER_CURRENT           21
#define  pVIEWER_REGION_CURRENT          22
...
int  CVICALLBACK analysis_panel(int panel, int event, void *callbackData, int eventData1, int eventData2);
