...
int ShutDownPanelOpen=0;    
int AboutPanelOpen=0; 
int ExcitePanelOpen=0;
...
// panel handles
static int  pEsca , pSplash ,pAbout , pShutDown;
// menu handles
static int mEsca;
...
struct instrumentStruct  EscaWest;  



int main (int argc, char *argv[])
{
	if (InitCVIRTE (argv) == 0)	/* Needed if linking in external compiler; harmless otherwise */
...
{
	/* AWK2011sep09 removing CIODIO48 interface from this file for testing;
	   will configure sequentially with IO calls in appropriate subfiles
	*//*
